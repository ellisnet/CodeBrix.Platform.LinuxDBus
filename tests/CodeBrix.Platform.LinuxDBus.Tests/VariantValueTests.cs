...
public class VariantValueTests
{
    ...
    public void ArrayOfDictionary()
    {
        ...
        VariantValue dict = VariantValue.Dictionary(DBusType.Byte, CodeBrix.Platform.LinuxDBus.Signature.String, new[] { item1, item2 });
    ...
    public void Dictionary(byte nesting)
    {
        var item1 = KeyValuePair.Create(VariantValue.Byte(1), VariantValue.String("one"));
        var item2 = KeyValuePair.Create(VariantValue.Byte(2), VariantValue.String("two"));
        VariantValue vv = Nest(VariantValue.Dictionary(DBusType.Byte, CodeBrix.Platform.LinuxDBus.Signature.String, new[] { item1, item2 }), nesting);
        UnwrapVariant(ref vv, nesting);
    ...
    [Theory(Skip = "Requires Linux (libc native library for Unix file descriptor handling).", SkipUnless = nameof(PlatformGate.IsLinux), SkipType = typeof(PlatformGate))]
    [InlineData(0)]
    [InlineData(1)]
