...
namespace CodeBrix.Platform.LinuxDBus.Tests //was previously: CodeBrix.Platform.LinuxDBus.Tests
{
    public class TransportTests
    {
        ...
        [Theory(Skip = "Requires Linux (dbus-daemon executable).", SkipUnless = nameof(PlatformGate.IsLinux), SkipType = typeof(PlatformGate))]
        ...
        public async Task ConnectionStream()
        {
            ...
            using (var dbusDaemon = new DBusDaemon())
            {
                ...
                await socket.ConnectAsync(new UnixDomainSocketEndPoint(path), TestContext.Current.CancellationToken);
